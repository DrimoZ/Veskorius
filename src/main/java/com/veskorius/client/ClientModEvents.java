...
public class ClientModEvents {
    ...
    public static void registerScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(ModMenuTypes.ADVANCED_ASSEMBLER.get(),
            com.veskorius.client.screen.AdvancedAssemblerScreen::new);
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.CUSTODE_LOURD.get(),
            com.veskorius.client.entity.CustodeLourdRenderer::new);
