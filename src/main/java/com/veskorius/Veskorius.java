    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> VESKORIUS_TAB =
        CREATIVE_TABS.register("veskorius_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ModItems.ANCIENT_CONDUIT_STONE_ITEM.get());
                output.accept(ModItems.METEORIC_RESONANCE_SHARD.get());
                ...
                output.accept(ModItems.CONVERGENCE_CORE_ITEM.get());
                output.accept(ModItems.RIFT_ANCHOR_ITEM.get());
                output.accept(ModItems.RIFT_CORE_EXTRACTOR_ITEM.get());
