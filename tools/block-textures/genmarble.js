...
const {MARBLE,V,C,A,S,marble,edges,slab,faces,front,side,top}=require('./marble');
...
const ACCENT={damping_array:C,deep_crystal_driller:A,slag_vent:{deep:'#6B3A12',mid:'#A8641F',lite:'#D08A3A',hot:'#EFC58A'},veskorian_alloy_forge:{deep:'#8E5A15',mid:'#D8922A',lite:'#F0B863',hot:'#FBE0B0'}};
const tex={};
